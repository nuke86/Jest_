...
function pagamento_mese($con, $mese, $id_persone, $causale){
	$anno = date("Y");
	$query = "SELECT * FROM abbonamenti WHERE id_persone = $id_persone AND causale = '$causale' AND mese = '$mese' AND data LIKE '$anno%'";
